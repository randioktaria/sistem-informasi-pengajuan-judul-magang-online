...
// melihat apakah ada judul yg telah di acc berdasarkan kode pkl
...
<div class="row">
	<div class="col-lg-12">
		<p><h2 align="center">PENGAJUAN JUDUL</h2></p><br>
...
if(isset($_POST['ajukan'])){
	...
	if($simpan){
		echo "<script>alert('Berhasil Diajukan');window.location.href='?p=pengajuan_judul';</script>";
	}else{
		echo "<script>alert('Gagal Megajukan');window.location.href='?p=pengajuan_judul';</script>";
	}
 }
}
?>
